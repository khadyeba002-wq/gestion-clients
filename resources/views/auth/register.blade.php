...
<style>
    ...
    *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    .form-title {
        font-family: 'Cormorant Garamond', serif;
        font-weight: 300; font-size: 40px; color: var(--dark);
    ...
    .form-desc {
        ...
        color: rgba(58,32,40,.38); letter-spacing: .5px; margin-bottom: 20px;
    ...
    .field:nth-child(2) { animation-delay: .70s; }
    .field:nth-child(3) { animation-delay: .78s; }
    .field:nth-child(4) { animation-delay: .86s; }

    .field label {
        display: block; font-size: 9px; letter-spacing: 3px;
        text-transform: uppercase; color: var(--gold); font-weight: 500; margin-bottom: 7px;
    }
    ...
    .field input {
        ...
        border-radius: 0; padding: 12px 44px 12px 16px;
    ...
    .btn-submit {
        ...
        z-index: 1;
        opacity: 0; animation: fadeUp .6s ease forwards .95s;
    }
    .btn-submit::before {
    ...
    .reg-row {
        ...
        position: relative; z-index: 1;
        opacity: 0; animation: fadeIn .6s ease forwards 1.12s;
    }
    ...
    @media (max-width: 768px) {
        ...
        .split-right { flex: 1; padding: 44px 28px; }
...
<div class="login-split">
    ...
    <div class="split-left">
        <img class="bg-photo" src="{{ asset('image/register.png') }}" alt="Lady's Home">
    ...
    <div class="split-right">
        ...
        <h1 class="form-title">Rejoignez <em>nous</em></h1>
        <p class="form-desc">Créez votre univers beauté</p>
            ...
            <div class="field">
                ...
                <div class="field-wrap">
                    <input id="password_confirmation" type="password" name="password_confirmation"
                           placeholder="••••••••"
                           required autocomplete="new-password">
                    <button type="button" class="eye-btn" onclick="togglePwd('password_confirmation', this)" tabindex="-1" aria-label="Afficher la confirmation">
                        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.6">
                            <path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"/>
                            <circle cx="12" cy="12" r="3"/>
                        </svg>
