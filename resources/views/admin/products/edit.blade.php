...
<style>
    ...
    *,*::before,*::after{box-sizing:border-box;margin:0;padding:0;}
    ...
    /* ── Alert ── */
    .alert-success{background:rgba(201,169,110,.1);border:1px solid rgba(201,169,110,.3);color:var(--dark);border-left:3px solid var(--gold);padding:12px 18px;margin-bottom:22px;font-size:12px;display:flex;align-items:center;gap:10px;opacity:0;animation:fadeUp .5s ease forwards .04s;}

    /* ── Image section ── */
    .current-img-wrap{margin-bottom:16px;}
    .current-img-label{font-size:9px;letter-spacing:2px;text-transform:uppercase;color:var(--muted);margin-bottom:8px;display:block;}
    .current-img{width:100%;aspect-ratio:1;object-fit:cover;border:1px solid rgba(201,169,110,.2);}
    .current-img-placeholder{width:100%;aspect-ratio:1;background:rgba(201,169,110,.06);border:1px dashed rgba(201,169,110,.25);display:flex;flex-direction:column;align-items:center;justify-content:center;gap:8px;}
    .current-img-placeholder span{font-size:36px;opacity:.3;}
    .current-img-placeholder p{font-size:10px;letter-spacing:2px;text-transform:uppercase;color:var(--muted);}
    .file-upload-wrap{position:relative;}
    .file-upload-label{display:flex;align-items:center;gap:12px;padding:12px 16px;background:#fff;border:1px dashed rgba(201,169,110,.4);cursor:pointer;transition:border-color .25s,background .25s;}
    .file-upload-label:hover{border-color:var(--gold);background:var(--gold-pale);}
    .upload-ico{font-size:18px;opacity:.6;}
    .upload-text strong{display:block;font-size:9px;letter-spacing:2px;text-transform:uppercase;color:var(--gold);margin-bottom:2px;}
    .upload-text{font-size:11px;color:var(--muted);letter-spacing:.5px;}
    .file-upload-wrap input[type="file"]{position:absolute;inset:0;opacity:0;cursor:pointer;width:100%;height:100%;}
    #imgPreview{width:100%;aspect-ratio:1;object-fit:cover;border:1px solid rgba(201,169,110,.2);display:none;margin-top:10px;}

    /* ── Buttons ── */
    .btn-submit{width:100%;padding:14px;background:linear-gradient(135deg,var(--deep-rose),var(--gold));border:none;color:#fff;font-family:'Raleway',sans-serif;font-size:11px;font-weight:500;letter-spacing:4px;text-transform:uppercase;cursor:pointer;position:relative;overflow:hidden;transition:transform .2s,box-shadow .2s;box-shadow:0 6px 22px rgba(196,116,138,.25);}
    ...
    .btn-delete-product{display:block;width:100%;padding:11px;background:transparent;border:1px solid rgba(196,116,138,.3);color:var(--deep-rose);font-family:'Raleway',sans-serif;font-size:10px;letter-spacing:3px;text-transform:uppercase;cursor:pointer;text-align:center;transition:all .2s;margin-top:10px;}
    .btn-delete-product:hover{background:rgba(196,116,138,.08);border-color:var(--deep-rose);}
...
<div class="page">
    ...
    <h1 class="page-title">Modifier le <em>Produit</em></h1>
        ...
        <div class="form-wrap">
            ...
            <div style="display:flex;flex-direction:column;gap:20px">
                ...
                <div class="card" style="animation-delay:.32s">
                    ...
                    <div class="card-body">
                        ...
                        <div class="current-img-wrap">
                            <span class="current-img-label">Image actuelle</span>
                            @if($product->image)
                            ...
                            @else
                                <div class="current-img-placeholder" id="imgPreviewCurrent">
                                    <span>🧴</span>
                                    <p>Aucune image</p>
                                </div>
                            @endif
                            <img id="imgPreview" src="" alt="Nouvelle image">
                        </div>
                        ...
                        <div class="field file-upload-wrap">
                            <label class="file-upload-label" for="imageInput">
                                ...
                                <div class="upload-text">
                                    <strong>Remplacer l'image</strong>
                ...
                <div class="card" style="animation-delay:.44s">
                    <div class="card-head">
                        <h3 style="font-size:14px;color:var(--deep-rose)">Zone <em>Danger</em></h3>
                    </div>
                    <div class="card-body">
                        ...
                        <p style="font-size:10px;color:rgba(156,122,128,.55);text-align:center;margin-top:8px;letter-spacing:.3px">Cette action est irréversible</p>
                    </div>
                </div>
...
function previewImg(input) {
    ...
    const current  = document.getElementById('imgPreviewCurrent');
